...
<div class="page">
  ...
  <table class="calendar-table table table-condensed table-tight"  style="width:1300px;background-color: white; margin-right:20px; margin-left:20px; ">
    <thead style="background-color: #163040;">
      <tr>
            ...
            <tr>
              <td style="text-align: left; margin-left:20px;">
                <span class="btn-group">
                  <button class="js-cal-prev btn btn-default" style=" margin-left:20px;"><</button>
              ...
              <td >
                <span class="btn-group btn-group-lg" >
                  {{ if (mode !== 'day') { }}
                    {{ if (mode === 'month') { }}<button class="js-cal-option btn btn-link" data-mode="year" style="color:white;display: block;">{{: months[month] }}</button>{{ } }}
                    {{ if (mode ==='week') { }}
                      <button class="btn btn-link disabled" style="color:white;display: block;">{{: shortMonths[first.getMonth()] }} {{: first.getDate() }} - {{: shortMonths[last.getMonth()] }} {{: last.getDate() }}</button>
                    {{ } }}
                    <button class="js-cal-years btn btn-link" style="color:white;display: block;">{{: year}}</button>
                  {{ } else { }}
                    <button class="btn btn-link disabled" style="color:white;display: block;">{{: date.toDateString() }}</button>
                  {{ } }}
                </span>
              </td>
              <td style="text-align: right;">
                <span class="btn-group">
                  <button style="margin-left:5px; margin-right:5px;" class="js-cal-option btn btn-default {{: mode==='year'? 'active':'' }}" data-mode="year">${sessionScope.get("bundle").getString("year")}</button>
                  <button style="margin-left:5px; margin-right:5px;" class="js-cal-option btn btn-default {{: mode==='month'? 'active':'' }}" data-mode="month">${sessionScope.get("bundle").getString("month")}</button>
                  <button style="margin-left:5px; margin-right:5px;" class="js-cal-option btn btn-default {{: mode==='week'? 'active':'' }}" data-mode="week">${sessionScope.get("bundle").getString("week")}</button>
                  <button style="margin-left:5px; margin-right:25px;" class="js-cal-option btn btn-default {{: mode==='day'? 'active':'' }}" data-mode="day">${sessionScope.get("bundle").getString("day")}</button>
                </span>
              </td>
            </tr>
          </table>
    ...
    <script>
        ...
        (function ($) {
            ...
            ;(function (defaults, $, window, document) {
                ...
                days: ["${sessionScope.get("bundle").getString("monday")}",
                    "${sessionScope.get("bundle").getString("tuesday")}",
                    "${sessionScope.get("bundle").getString("wednesday")}",
                    "${sessionScope.get("bundle").getString("thursday")}",
                    "${sessionScope.get("bundle").getString("friday")}",
                    "${sessionScope.get("bundle").getString("saturday")}",
                    "${sessionScope.get("bundle").getString("sunday")}"],
                months: ["${sessionScope.get("bundle").getString("January")}",
                    "${sessionScope.get("bundle").getString("February")}",
                    "${sessionScope.get("bundle").getString("March")}",
                    "${sessionScope.get("bundle").getString("April")}",
                    "${sessionScope.get("bundle").getString("May")}",
                    "${sessionScope.get("bundle").getString("June")}",
                    "${sessionScope.get("bundle").getString("July")}",
                    "${sessionScope.get("bundle").getString("August")}",
                    "${sessionScope.get("bundle").getString("September")}",
                    "${sessionScope.get("bundle").getString("October")}",
                    "${sessionScope.get("bundle").getString("November")}",
                    "${sessionScope.get("bundle").getString("December")}"],
                shortMonths: ["${sessionScope.get("bundle").getString("January")}",
                    "${sessionScope.get("bundle").getString("February")}",
                    "${sessionScope.get("bundle").getString("March")}",
                    "${sessionScope.get("bundle").getString("April")}",
                    "${sessionScope.get("bundle").getString("May")}",
                ...
                todayname: "${sessionScope.get("bundle").getString("current")}",
