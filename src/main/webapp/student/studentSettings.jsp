    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">${sessionScope.get("bundle").getString("deletingAccount")}</h5>
    ...
    <div class="row" style="margin-top: 60px;">
        ...
        <div class="col-sm-9">
            ...
            <div class="container-fluid">
                ...
                <form action="/project/controller?command=fillBalance" method="post">

                    <div style="margin-top: 40px">
                        <p><b>${sessionScope.get("bundle").getString("updateBalance")}: </b></p>
                        <p><b>${sessionScope.get("bundle").getString("yourBalance")}: ${user.balance}</b></p>
                ...
                <div style="margin-top: 45px">
                    ...
                    <p class="text-danger"><b>${sessionScope.get("bundle").getString("accountDeletingWarning")}</b>
                    </p>
                    <button type="submit" class="btn btn-default"
