        ...
        <nav class="sidenav" id="sidebar">
            ...
            <div class="nav navbar-header">
                ...
                <div class="dropdown" style="margin-left: 15px;">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/project/controller?command=teacherCourses&lang=en">EN</a></li>
                        <li><a href="/project/controller?command=teacherCourses&lang=ua">UKR</a></li>
            ...
            <div style="padding-top: 50px">
                ...
                <div class="btn-group-vertical" style="padding: 20px;">
                    <a href="/project/controller?command=teacherCourses">
                    ...
                    <br>
                    <a href="/project/controller?command=teacherMessages">
                        <button type="button" class="myButton">
                            <span class="glyphicon glyphicon-envelope"></span> ${sessionScope.get("bundle").getString("myMessages")}
                        </button>
                    </a>
                    <br>
